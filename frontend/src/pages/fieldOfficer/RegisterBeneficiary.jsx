...
//       setIsSuccess(true);
//       setShowConfirm(false);
//       setTimeout(() => navigate("/fo/beneficiaries"), 2000);
//     } catch (err) {
...
//                       <th className="p-3 text-xs font-bold uppercase text-gray-600 w-[10%]">House No (optional)</th>
//                       <th className="p-3 text-xs font-bold uppercase text-gray-600 w-[12%]">Thram No (optional)</th>
...
//                         </td>
//                         <td className="p-2">
//                           <input  type="text" placeholder="House No." className="w-full p-2 text-sm border rounded-lg outline-none bg-white"
