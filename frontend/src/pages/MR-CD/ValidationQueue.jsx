  ...
  return (
    <div className="space-y-6">
      {/* <header className="mb-6">
        <h1 className="text-lg sm:text-xl font-bold text-gray-800">Validation Queue</h1>
        <p className="text-xs sm:text-[13px] text-gray-500 font-medium">Validate Quantities for Key Activities</p>
      </header> */}
