...
const Dashboard = () => {
  ...
  const roleName = user?.role?.roleName || "Management";
...
<div className="w-full flex justify-center items-center py-4 sm:py-6 lg:py-8 overflow-hidden">
  
  {/* UPDATED WIDTH */}
  <div className="w-full max-w-[1500px] lg:max-w-[1800px]">
